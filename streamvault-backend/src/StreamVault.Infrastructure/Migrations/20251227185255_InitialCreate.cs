        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripePriceIdYearly = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsCustom = table.Column<bool>(type: "boolean", nullable: false),
                    Features = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: true),
                    Limits = table.Column<Dictionary<string, object>>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerLogoUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    PlayerLogoPosition = table.Column<int>(type: "integer", nullable: true),
